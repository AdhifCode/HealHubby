  ...
  <div class="container">
    <div class="pt-8 w-9/12">
      ...
      <div class="pt-0 pb-0">
        <div class="pb-0">
          <div class="p-4">
            ...
            <input
              ...
              placeholder="hubby@heal.com"
            />
            <div class="pt-4 pb-2">Password</div>
            <label
        ...
        <div class="pt-4 pb-4 text-center">OR</div>
        <div class="flex">
          <button
            @click="socialLogin('google')"
            class="flex btn btn-outline rounded-lg mr-2 text-lg"
            style="width: 49%"
          >
            <svg
              class="w-6 h-6"
          ...
          <button
            ...
            class="flex btn btn-outline rounded-lg text-lg"
            style="width: 49%"
          >
            <svg
              class="w-6 h-6"
