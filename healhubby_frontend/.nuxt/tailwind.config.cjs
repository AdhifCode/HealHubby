module.exports = {
  ...
  "content": {
    "relative": false,
    "files": [
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/components/**/*.{vue,js,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/layouts/**/*.{vue,js,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/pages/**/*.{vue,js,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/composables/**/*.{js,ts,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/utils/**/*.{js,ts,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/{A,a}pp.{vue,js,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/{E,e}rror.{vue,js,mjs}",
      "C:/xampp/htdocs/PJBL_XII/healhubby_frontend/app.config.{js,ts,mjs}"
    ],
    "extract": {},
    "transform": {}
  },
